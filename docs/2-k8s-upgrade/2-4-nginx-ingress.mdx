...
Ingress NGINX Controller는 K8S 환경에서 NGINX를 reverse proxy와 load balancer로 사용하게 해 줍니다. 클라이언트의 요청을 안정적으로 받아 라우팅까지 할 수 있어 최근에 높은 관심을 받고 있는 MSA 환경을 구성하는 데 효과적입니다.
